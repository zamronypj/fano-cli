 ...
 *------------------------------------------------------------- *)
unit CreateAppBootstrapFancyTaskFactoryImpl;
...
type
     ...
     * using TFpHttpServer with Fancy template
     *
     * @author Zamrony P. Juhara <zamronypj@yahoo.com>
     *---------------------------------------*)
    TCreateAppBootstrapFancyTaskFactory = class(TCreateAppBootstrapTaskFactory)
    protected
...
uses
    ...
    function TCreateAppBootstrapFancyTaskFactory.buildBootstrapTask(
        const textFileCreator : ITextFileCreator;
        const contentModifier : IContentModifier
    ) : ITask;
    begin
