 ...
 *------------------------------------------------------------- *)
unit CreateFcgiAppFileTaskImpl;
...
type
     ...
     *---------------------------------------*)
    TCreateFcgiAppFileTask = class(TCreateAppFileTask)
    private
...
uses
    ...
    function TCreateFcgiAppFileTask.getHost(const opt : ITaskOptions) : string;
    begin
    ...
    function TCreateFcgiAppFileTask.getPort(const opt : ITaskOptions) : string;
    begin
        //TODO: refactor as this is exactly same as getHost() in TBaseApacheVirtualHostTask
    ...
    procedure TCreateFcgiAppFileTask.createApp(
        const opt : ITaskOptions;
        const longOpt : shortstring;
        const dir : string
    );
